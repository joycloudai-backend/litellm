...
class SpendLogsMetadata(TypedDict):
    ...
    async_billing_only: Optional[bool]  # Skip request counters for deferred video billing rows
    provider_spend_currency: Optional[str]
    provider_spend_amount: Optional[float]
